...
class JSJOBSCommonModel {
        ...
        switch ($tablename) {
            ...
            case "subcategories":
                if (self::checkCanMakeDefault($id, $tablename)) {
                    ...
                    $query = "UPDATE  `" . jsjobs::$_db->prefix . "js_job_" . $tablename . "` AS t SET t." . $column . " = 1 WHERE id=" . esc_sql($id);
    ...
    function checkCanMakeDefault($id, $tablename) {
        ...
        $query = "SELECT " . $column . " FROM `" . jsjobs::$_db->prefix . "js_job_" . $tablename . "` WHERE id=" . esc_sql($id);
