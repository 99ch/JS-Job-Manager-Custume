...
class JSJOBSControllerinstallerController {
    ...
    function updateConfiguration($data) {
        ...
        $query = "UPDATE `" . jsjobs::$_db->prefix . "js_job_config` SET configvalue = '" . esc_sql($data['showemployerlink']) . "' WHERE configname = 'showemployerlink'";
        jsjobsdb::query($query);
        
        $query = "UPDATE `" . jsjobs::$_db->prefix . "js_job_config` SET configvalue = '" . esc_sql($data['newlisting_requiredpackage']) . "' WHERE configname = 'newlisting_requiredpackage'";
        jsjobsdb::query($query);
        
        
        $query = "UPDATE `" . jsjobs::$_db->prefix . "js_job_config` SET configvalue = '" . esc_sql($data['visitor_can_post_job']) . "' WHERE configname = 'visitor_can_post_job'";
        jsjobsdb::query($query);
        
        $query = "UPDATE `" . jsjobs::$_db->prefix . "js_job_config` SET configvalue = '" . esc_sql($data['js_newlisting_requiredpackage']) . "' WHERE configname = 'js_newlisting_requiredpackage'";
        jsjobsdb::query($query);
        
        $query = "UPDATE `" . jsjobs::$_db->prefix . "js_job_config` SET configvalue = '" . esc_sql($data['visitor_can_apply_to_job']) . "' WHERE configname = 'visitor_can_apply_to_job'";
        jsjobsdb::query($query);
        
        $query = "UPDATE `" . jsjobs::$_db->prefix . "js_job_config` SET configvalue = '" . esc_sql($data['offline']) . "' WHERE configname = 'offline'";
        jsjobsdb::query($query);
    }
